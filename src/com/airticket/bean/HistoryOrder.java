 ...
 */
@Entity
@Table(name = "p1_history_order", catalog = "airticket")
public class HistoryOrder extends Order implements java.io.Serializable {
	...
	/** minimal constructor */
	public HistoryOrder(String orderid, String departCityCode,
